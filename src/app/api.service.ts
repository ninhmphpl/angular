...
export class ApiService {
  ...
  getTemplate() {
    ...
    this.http.get(urlHost + "/api/couple/template?edit=true&version=100" + group, this.login.getHeader()).subscribe((value: any) => {
      this.templates = value.data
    }, error => alert(error.error.detail))
  }

  createTemplate() {
    this.http.post(urlHost + "/api/couple/template", new Template(), this.login.getHeader()).subscribe((value: any) => {
      this.templates.unshift(value.data)
    }, error => alert(error.error.detail))
  }

  updateTemplate(index: number) {
    this.http.post(urlHost + "/api/couple/template", this.templates[index], this.login.getHeader()).subscribe((value: any) => {
      this.templates[index] = value.data
    }, error => alert(error.error.detail))
  }

  deleteTemplate(index: number) {
    this.http.delete(urlHost + "/api/couple/template/" + this.templates[index].id, this.login.getHeader()).subscribe((value: any) => {
      this.templates[index] = value.data
  ...
  getGroup() {
    this.http.get(urlHost + "/api/couple/group?edit=true&version=100", this.login.getHeader()).subscribe((value: any) => {
      this.groups = value.data
    }, error => alert(error.error.detail))
  }

  createGroup() {
    this.http.post(urlHost + "/api/couple/group", new Group(), this.login.getHeader()).subscribe((value: any) => {
      this.groups.unshift(value.data)
    }, error => alert(error.error.detail))
  }

  updateGroup(index: number) {
    this.http.post(urlHost + "/api/couple/group", this.groups[index], this.login.getHeader()).subscribe((value: any) => {
  ...
  getMusic() {
    ...
    this.http.get(urlHost + "/api/couple/music?edit=true&version=100", this.login.getHeader()).subscribe((value: any) => {
