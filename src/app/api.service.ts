...
export class ApiService {
  ...
  getTemplate() {
    ...
    this.http.get(urlHost + "/api/couple/template?edit=true&version=100" + group).subscribe((value: any) => {
  ...
  getGroup() {
    this.http.get(urlHost + "/api/couple/group?edit=true&version=100").subscribe((value: any) => {
